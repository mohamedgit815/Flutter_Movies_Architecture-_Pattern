...
import 'package:flutter_movies_app/Movies/Presentation/Screens/movie_details_screen.dart';
              ...
              child: CarouselSlider(
                ...
                items: state.nowPlayingMovies.map(
                    ...
                    return GestureDetector(
                      ...
                      onTap: () {
                        Navigator.of(context).push(CupertinoPageRoute(builder: (context)=>MovieDetailScreen(id: item.id)));
